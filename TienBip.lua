...
shared.LoaderTitle = "Đăng Ký Kênh TienBip Roblox";
...
function Hop()
    ...
    function TPReturner()
        ...
        if (v374 == "") then
            ...
            v556 = game.HttpService:JSONDecode(game:HttpGet("https://games.com/v1/games/" .. v372 .. "/servers/Public?sortOrder=Asc&limit=100&cursor=" .. v374));
        end
        local v557 = "";
...
spawn(function()
    while wait() do
        if _G.AutoRejoin then
            getgenv().rejoin = game:GetService("CoreGui").

PromptGui.promptOverlay.ChildAdded:Connect(function(v808)
